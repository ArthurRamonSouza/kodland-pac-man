class Ghost:
    ...
    def __init__(self, x_coord, y_coord, target, speed, img, direct, dead, box, id, level, HEIGHT, WIDTH, screen, powerup, eaten_ghost, spooked_img, dead_img, pygame):
        self.x_pos = x_coord
        self.y_pos = y_coord
        ...
        self.in_box = box
        self.id = id
        self.turns, self.in_box = self.check_collisions(HEIGHT, WIDTH, level)
        self.rect = self.draw(screen, powerup, eaten_ghost, spooked_img, dead_img, pygame)


    def draw(self, screen, powerup, eaten_ghost, spooked_img, dead_img, pygame):
    ...
    def check_collisions(self, height, width, level):
        num1 = ((height - 50) // 32)
        num2 = (width // 30)
        num3 = 15
